...
```bash
npx shadcn@latest add https://usekit.kiron.dev/r/use-debounce-callback
```
...
| Name   | Type         | Description                                                                                 |
| ------ | ------------ | ------------------------------------------------------------------------------------------- |
| `func` | `() => void` | The debounced function that can be called to execute the original function after the delay. |
