...
| `options?` | `{ loading?: React.ReactNode, success?: (data: TData) => React.ReactNode, error?: (error: TError) => React.ReactNode }` | Custom JSX to render for loading, success, and error states.                     |
