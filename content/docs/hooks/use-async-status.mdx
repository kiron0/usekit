...
| `options?` | `{ loading?: React.ReactNode, success?: (data: TData) => React.ReactNode, error?: (error: TError) => React.ReactNode }` | (Optional) Custom JSX to render for loading, success, and error states.                     |
