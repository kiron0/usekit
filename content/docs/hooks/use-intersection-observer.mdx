...
```bash
npx shadcn@latest add https://usekit.kiron.dev/k/use-intersection-observer
```
...
| `options`    | `UseIntersectionObserverProps` | Optional configuration for the Intersection Observer.         | [See Below](#props) | Yes      |
