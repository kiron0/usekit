...
<ComponentPreview name="use-encryption-demo" />
...
```bash
npx shadcn@latest add https://usekit.kiron.dev/k/use-encryption
```
...
If you are using `TypeScript`, you may also need to install the types `@types/crypto-js` as a dev dependency

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="use-encryption" />
