...
description: Track when a component is rendered for the first time with useIsFirstRender.
---
...
```bash
npx shadcn@latest add https://usekit.kiron.dev/k/use-is-first-render
```
