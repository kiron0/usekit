    ...
    <div className="flex w-full flex-col items-center justify-center gap-6">
      ...
      {isModalOpen && (
        <>
          ...
          <div
            ref={modalRef}
            className="fixed left-1/2 top-1/2 z-[49] grid w-[95%] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl border bg-background p-6 shadow-md md:z-[999] md:w-full"
          >
